//! ref: http://stackoverflow.com/questions/7412042/hdf5-c-interface-writing-dynamic-2d-arrays
#include <cstdint>
#include <string>
#include <vector>
#include <H5Cpp.h>
...
void do_write_hdf5(H5::H5File file, const std::string& data_set_name, const boost::multi_array<T, DIMENSIONS>& data, hdf5_data_type& datatype)
{
    ...
    // make vector {nx, ny, nz} by passing address first and last + 1
